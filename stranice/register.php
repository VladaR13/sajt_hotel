...
<body>
  ...
  <?php if (isset($_SESSION['korisnik_id'])): ?>
        <a href="stranice/logout/logout.php" class="bg-red-500 text-white px-4 py-2 rounded">Odjavi se</a>
    <?php else: ?>
        <a href="stranice/login/login.php" class="bg-blue-500 text-white px-4 py-2 rounded">Prijavi se</a>
    <?php endif; ?>
    ...
    <form action="register.php"  method="POST">
      <div class="w-5/6 lg:w-1/2 mx-auto bg-white rounded shadow-xl">
        ...
        <p class="text-center my-4">
            <a href="login.php" class="text-grey-dark text-sm no-underline hover:text-grey-darker">Vec imam nalog.</a>
        </p>
    </div>
